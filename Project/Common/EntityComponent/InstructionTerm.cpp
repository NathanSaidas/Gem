...
namespace Gem
{
	namespace EntityComponent
	{
		...
		InstructionTerm::InstructionTerm(std::string aName, std::string aValue) : object(),
			m_Name(aName),
			m_Value(aValue)
		{

		}
		InstructionTerm::InstructionTerm(std::string aName, SInt32 aValue) : object(),
			m_Name(aName)
		{
			SetValue(aValue);
		}
		InstructionTerm::InstructionTerm(std::string aName, UInt32 aValue) : object(),
			m_Name(aName)
		{
			SetValue(aValue);
		}
		InstructionTerm::InstructionTerm(std::string aName, bool aValue) : object(),
			m_Name(aName)
		{
			SetValue(aValue);
		}
		InstructionTerm::InstructionTerm(std::string aName, Float32 aValue) : object(),
			m_Name(aName)
		{
			SetValue(aValue);
		}
